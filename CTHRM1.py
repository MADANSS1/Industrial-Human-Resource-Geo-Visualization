...
st.set_page_config(page_title= "Human Source", layout= "wide", initial_sidebar_state= "expanded",
                 )
st.markdown("<h1 style='text-align: center; color: black;'>Industrial Human Resource Geo-Visualization</h1>", unsafe_allow_html=True)



data = pd.read_csv(r"C:\Users\User\OneDrive\Desktop\vs_python\final_HR.csv")
